...
// Your preference
// 0: Pads only on one side
// 1: Pads on both sides, connected together
...
static void kicad_mod_silkscreen(void)
{
	...
	x4 = -18.5; y4 = 18.5;
  	...
  	// right line
	printf("  (fp_line (start %.3f %.3f) (end %.3f %.3f) (layer \"F.SilkS\") (width 0.12) (tstamp 00000000-0000-0000-0000-000000000000))\n", x2, y2 + 1, x3, y3);
	// left line
	printf("  (fp_line (start %.3f %.3f) (end %.3f %.3f) (layer \"F.SilkS\") (width 0.12) (tstamp 00000000-0000-0000-0000-000000000000))\n", x4, y4, x1, y1);
  	// bottom line
	printf("  (fp_line (start %.3f %.3f) (end %.3f %.3f) (layer \"F.SilkS\") (width 0.12) (tstamp 00000000-0000-0000-0000-000000000000))\n", x3, y3, x4, y4);
  ...
  // right horiz edge top
	printf("  (fp_line (start 13.675 -14.8) (end 14.175 -14.8) (layer \"F.SilkS\") (width 0.1) (tstamp 00000000-0000-0000-0000-000000000000))\n");

  // \ <--
	printf("  (fp_line (start 14.175 -14.8) (end 15.325 -13.65) (layer \"F.SilkS\") (width 0.1) (tstamp 00000000-0000-0000-0000-000000000000))\n");
  // left horiz edge top
	printf("  (fp_line (start -13.675 -14.8) (end -15.325 -14.8) (layer \"F.SilkS\") (width 0.1) (tstamp 00000000-0000-0000-0000-000000000000))\n");
  // right vert edge top
	printf("  (fp_line (start 15.325 -13.65) (end 15.325 -13.15) (layer \"F.SilkS\") (width 0.1) (tstamp 00000000-0000-0000-0000-000000000000))\n");
  // right vert line bottom
	printf("  (fp_line (start 15.325 15.85) (end 15.325 14.2) (layer \"F.SilkS\") (width 0.1) (tstamp 00000000-0000-0000-0000-000000000000))\n");
  // left hor line bottom
	printf("  (fp_line (start -13.675 15.85) (end -15.325 15.85) (layer \"F.SilkS\") (width 0.1) (tstamp 00000000-0000-0000-0000-000000000000))\n");
  // left vert line bottom
	printf("  (fp_line (start -15.325 15.85) (end -15.325 14.2) (layer \"F.SilkS\") (width 0.1) (tstamp 00000000-0000-0000-0000-000000000000))\n");
  // left vert line top
	printf("  (fp_line (start -15.325 -14.8) (end -15.325 -13.15) (layer \"F.SilkS\") (width 0.1) (tstamp 00000000-0000-0000-0000-000000000000))\n");
  // right vert line bottom
	printf("  (fp_line (start 13.675 15.85) (end 15.325 15.85) (layer \"F.SilkS\") (width 0.1) (tstamp 00000000-0000-0000-0000-000000000000))\n");
#endif
}
...
{
	printf ("(model \"${KISYS3DMOD}/Package_LCC.3dshapes/PLCC-84_SMD-Socket.wrl\"\n"
		"    (offset (xyz 0 0 0))\n"
		"    (scale (xyz 1 1 1))\n"
		"    (rotate (xyz 0 0 0))\n"
		"  )\n");
...
//  36.6 27.5 36.6 27.6
#if 0
static void pad(int n, double px, double py, double sx, double sy)
{
